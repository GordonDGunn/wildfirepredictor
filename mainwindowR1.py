...
# Form implementation generated from reading ui file 'mainwindowR1.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.predict_button = QtWidgets.QPushButton(self.widget)
        self.predict_button.setGeometry(QtCore.QRect(50, 20, 113, 32))
        self.predict_button.setObjectName("predict_button")
        self.prediction_result = QtWidgets.QLineEdit(self.widget)
        self.prediction_result.setGeometry(QtCore.QRect(180, 20, 113, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.predict_button.setText(_translate("MainWindow", "Fire Risk?"))
